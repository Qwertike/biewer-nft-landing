    ...
    return (_jsxs(Container, { animate: "fadein", style: {
            minHeight: "200px",
                    ...
                    maxHeight: "350px",
                            ...
                            if (!wallet)
                                return null;
                            return (_jsx(WalletRowWithBalances, { wallet: wallet, balances: balances, client: props.client, address: address, onClick: (wallet, token, chain) => {
                                    trackPayEvent({
                        ...
                        }), filteredWallets.length > 0 && _jsx(TextDivider, { text: "OR" }), _jsx(Button, { variant: "secondary", fullWidth: true, onClick: () => {
                                trackPayEvent({
                                ...
                                padding: spacing.sm,
                            }, children: _jsxs(Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [_jsx(OutlineWalletIcon, { size: iconSize.md }), _jsx(Text, { size: "sm", color: "primaryText", children: "Pay with another wallet" })] }) }), props.fiatSupported && (_jsx(Button, { variant: "secondary", fullWidth: true, onClick: () => {
                                trackPayEvent({
                                ...
                                border: `1px solid ${theme.colors.borderColor}`,
                                padding: spacing.sm,
                            }, children: _jsxs(Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [_jsx(CardStackIcon, { width: iconSize.md, height: iconSize.md }), _jsx(Text, { size: "sm", color: "primaryText", children: "Pay with card" })] }) }))] }) })] }));
}
