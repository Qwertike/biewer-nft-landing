    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", style: {
            minHeight: "200px",
                    ...
                    maxHeight: "350px",
                            ...
                            if (!wallet)
                                return null;
                            return ((0, jsx_runtime_1.jsx)(WalletRowWithBalances, { wallet: wallet, balances: balances, client: props.client, address: address, onClick: (wallet, token, chain) => {
                        ...
                        }), filteredWallets.length > 0 && (0, jsx_runtime_1.jsx)(TextDivider_js_1.TextDivider, { text: "OR" }), (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "secondary", fullWidth: true, onClick: () => {
                                (0, pay_js_1.trackPayEvent)({
                            ...
                            }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [(0, jsx_runtime_1.jsx)(OutlineWalletIcon_js_1.OutlineWalletIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", children: "Pay with another wallet" })] }) }), props.fiatSupported && ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "secondary", fullWidth: true, onClick: () => {
                                (0, pay_js_1.trackPayEvent)({
                                ...
                                border: `1px solid ${theme.colors.borderColor}`,
                                padding: index_js_1.spacing.sm,
                            }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [(0, jsx_runtime_1.jsx)(react_icons_1.CardStackIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", children: "Pay with card" })] }) }))] }) })] }));
}
